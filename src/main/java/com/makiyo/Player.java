...
public class Player extends Thread
{
    ...
    public Player(String[] notes, int times)
    {
        this.notes = notes;
        this.times = times;
    }
    ...
    public Player(String[] notes, int times, Mode mode)
    {
        this.notes = notes;
        this.times = times;
        this.mode = mode;
    ...
    public Player(String filePath, int times)
    {
    ...
    public Player loadNotes(String notes)
    {
